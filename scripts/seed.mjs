...
tx.createOrReplace({
  ...
  footerText: 'Confraternita di Misericordia di Gello ODV — Volontariato, soccorso e aggregazione sociale dal 1982.',
  address: 'Via della Misericordia 12, 51100 Gello (PT)',
  phone: '0573 000000',
...
tx.createOrReplace({
  ...
  heroSection: {
    kicker: 'Misericordia di Gello dal 1982',
...
tx.createOrReplace({
  ...
  heroSection: {
    ...
    headingPre: 'Quarant\'anni di',
    headingEm: 'servizio',
    headingPost: 'alla comunità',
    body: 'Fondata nel 1982 da un gruppo di volontari, la Misericordia di Gello è cresciuta fino a diventare un punto di riferimento per l\'intera Valdinievole.',
  },
})
      ...
      progetti: [
        {
          ...
          posti: 2,
          sede: 'Sede Misericordia di Gello, Via della Misericordia 12',
