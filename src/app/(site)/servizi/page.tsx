...
export const metadata: Metadata = {
  ...
  description:
    "Trasporto sanitario, emergenza 118, protezione civile e assistenza sociale: scopri tutti i servizi attivi h24 della Misericordia di Gello.",
};

export default async function ServiziPage() {
  const [servizi, mezzi] = await Promise.all([
    client.fetch<ServizioListItem[]>(
      SERVIZI_QUERY,
      { lang: "it" },
      { next: { tags: ["servizio"] } },
    ),
    client.fetch<MezzoListItem[]>(
      MEZZI_QUERY,
      {},
      { next: { tags: ["mezzo"] } },
    ),
