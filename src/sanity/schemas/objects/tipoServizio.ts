...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'durata', title: 'Durata (es. 12 mesi)', type: 'string' }),
    defineField({ name: 'eta', title: 'Età (es. 18 – 28 anni)', type: 'string' }),
    defineField({ name: 'impegno', title: 'Impegno settimanale', type: 'string' }),
    defineField({ name: 'compenso', title: 'Compenso mensile (es. € 507,30)', type: 'string' }),
    ...
    defineField({ name: 'scadenzaOra', title: 'Ora scadenza (es. 14:00)', type: 'string' }),
    defineField({
